    ...
    <div className="max-w-6xl mx-auto px-4 py-5 md:py-20">
      <div className="flex md:flex-row justify-between items-center">
        ...
        <div className="hidden md:flex">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" className={`w-6 h-6 ${darkMode ? 'text-yellow-500 dark:text-yellow-500' : 'text-gray-600 dark:text-gray-400'}`}>
              {darkMode ?
      ...
      <div className="md:hidden mt-4">
        <nav>
          <div className="background z-30" style={{ clipPath: 'circle(4.5% at 87% 6%)' }}></div>
          ...
          <ul className="z-40 p-5 absolute top-[100px] w-[260px]">
            <li className="absolute -top-16 flex items-center mb-5 space-x-6 cursor-pointer" style={{ opacity: 0, transform: 'translateY(50px) translateZ(0px)' }}>
              <button aria-label="Toggle Dark Mode" type="button" className="w-10 h-10 px-3 rounded focus:outline-none">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" className="w-6 h-6 text-yellow-500 dark:text-yellow-500">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path>
                </svg>
              </button>
            </li>
            <li className="flex items-center mb-5 space-x-6 cursor-pointer" style={{ opacity: 0, transform: 'translateY(50px) translateZ(0px)' }}>
              <a href="/about">
