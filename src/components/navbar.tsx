...
function Navbar() {
  ...
  useEffect(() => {
    // Retrieve darkMode state from localStorage on page load
    ...
    <div className="max-w-6xl mx-auto px-4 py-5 md:py-20">
      <div className="flex md:flex-row justify-between items-center">
        ...
        <div className="md:hidden mt-4">
          <nav>
            <div className={`background z-30 ${showMenu ? 'open' : ''}`} style={{ clipPath: 'circle(122% at 88% 16%)' }}></div>
            ...
            {showMenu && (
              <ul className={`z-40 p-5 absolute top-0 right-0 ${darkMode ? 'bg-black' : 'bg-white'} shadow-md rounded-md h-screen w-[80%] max-h-screen overflow-y-auto transition-opacity duration-500`}>
                <li
                  className="flex items-center mb-5 space-x-6 cursor-pointer transition-opacity duration-500 justify-between"
                  style={{
                    opacity: 1,
                ...
                >
                  ...
                  <button className="z-40" onClick={closeMenu}>
                    <svg width="23" height="23" viewBox="0 0 23 23">
                      <path fill="transparent" strokeWidth="3" stroke="hsl(0, 0%, 18%)" strokeLinecap="round" d="M 3 16.5 L 17 2.5"></path>
                      <path fill="transparent" strokeWidth="3" stroke="hsl(0, 0%, 18%)" strokeLinecap="round" d=""></path>
                      <path fill="transparent" strokeWidth="3" stroke="hsl(0, 0%, 18%)" strokeLinecap="round" d="M 3 2.5 L 17 16.346"></path>
                    </svg>
                  </button>
